...
from config import testrail_data as ts, run_id
...
def add_result_for_case(run_id, case_id, status):
    ...
    data = {'status_id': status, 'comment': 'The result was added automatically.', 'version': '1.3.0', 'elapsed': None,
            'defects': None, 'assignedto_id': id_user}
